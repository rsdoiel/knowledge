...
DR-0040  2026-09-24  superseded   correction   live-test        sup   kb exits 2 for a mistake in the command line and 1 for everything else
...
DR-0003  2026-08-08  accepted     decision     -                sup   JSON-L export/import: the no-file-access alternative to `merge`
